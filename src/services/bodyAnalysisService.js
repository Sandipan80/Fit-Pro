...
export const PHYSIQUE_CHARACTERISTICS = {
  ...
  [BODY_TYPES.ECTO_MESOMORPH]: {
    name: 'Ecto-Mesomorph',
    description: 'Combination of thin frame with athletic potential',
    characteristics: [
      'Thin frame with athletic potential',
      'Can build muscle with proper training',
      'Moderate metabolism',
      'Good response to strength training',
      'Narrow but defined structure',
      'Good endurance capabilities'
    ],
    workoutFocus: [
      'Progressive strength training',
      'Compound movements with moderate volume',
    ...
    muscleBuildingPotential: 'moderate_high',
    fatGainTendency: 'low',
    recoveryRate: 'moderate'
  },
  [BODY_TYPES.MESO_ENDOMORPH]: {
    name: 'Meso-Endomorph',
    description: 'Athletic build with tendency to gain weight',
    characteristics: [
      'Athletic build with weight gain tendency',
    ...
    dietFocus: [
      ...
      'High protein (1.8-2.2g per kg body weight)',
      'Moderate carbs with timing',
      'Regular meal timing',
      'Adequate hydration',
      'Portion control strategies'
    ],
    metabolism: 'moderate_slow',
    muscleBuildingPotential: 'high',
    fatGainTendency: 'high',
    recoveryRate: 'fast'
  },
  ...
  [BODY_TYPES.LEAN_ENDOMORPH]: {
    name: 'Lean Endomorph',
    description: 'Naturally heavier but with good muscle definition potential',
    characteristics: [
      'Naturally heavier but lean',
      'Good muscle building potential',
      'Moderate metabolism',
      'Strong and powerful',
    ...
    metabolism: 'moderate',
    muscleBuildingPotential: 'high',
    fatGainTendency: 'moderate_high',
    recoveryRate: 'moderate'
  },
  [BODY_TYPES.BALANCED_HYBRID]: {
    name: 'Balanced Hybrid',
    description: 'Balanced body type with mixed characteristics',
    characteristics: [
      'Balanced body proportions',
      'Moderate metabolism',
      'Good adaptation to training',
      'Versatile fitness potential',
    ...
    dietFocus: [
      ...
      'Moderate protein (1.6-2.0g per kg body weight)',
      'Flexible carb and fat ratios',
      'Quality nutrition sources',
      'Regular meal timing',
...
export class BodyAnalysisService {
  ...
  determineAdvancedBodyType(analysis) {
    ...
    if (maxComponent === ectomorphy) {
      ...
      if (mesomorphy >= 2) return BODY_TYPES.LEAN_ENDOMORPH;
  ...
  generateDietPlan(bodyType, goals, weight, height, activityLevel = 'moderate') {
  ...
  saveAnalysis(userId, analysis) {
    ...
    localStorage.setItem(`bodyAnalysis_${userId}`, JSON.stringify(analysisData));
  ...
  loadAnalysis(userId) {
    const saved = localStorage.getItem(`bodyAnalysis_${userId}`);
